...
Processes judo match videos through:
  ...
  2. llama.cpp (qwen2.5vl) multi-pass vision analysis
...
class JudoAnalysisPipeline:
    def __init__(self, workspace_dir: str):
        ...
        self.analyzer = JudoAnalyzer(
            model=self.config.get("vision_model", "qwen2.5vl"),
            base_url=self.config.get("vision_base_url", "http://192.168.2.114:8080"),
        )
    ...
    def process_video(self, video_path: str) -> str:
        ...
        try:
            ...
            # Step 2: Run llama.cpp (OpenAI-compatible) vision analysis
            logger.info("Step 2/2: Running llama.cpp vision analysis...")
